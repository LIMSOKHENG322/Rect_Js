...
import envelopimage from '../images/envelope-outline.png';
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="subscription-form">
            <h3 class="d-flex align-items-center"><span class="me-1"><img src={envelopimage} alt="Image" class="img-fluid"/></span><span>Subscribe to Newsletter</span></h3>
